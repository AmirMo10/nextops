...
const translations = {
  en: {
    ...
    fallbackIntegrityNotice: "The generated wording failed an integrity check, so NextOps replaced it with a deterministic safe response.",
  ...
  fa: {
    ...
    fallbackIntegrityNotice: "متن تولیدشده یکی از کنترل‌های صحت را نگذرانده است؛ بنابراین NextOps آن را با پاسخی قطعی و ایمن جایگزین کرد.",
