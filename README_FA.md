...
> **وضعیت فعلی: مسیر دوزبانهٔ مرحلهٔ دو روی چهار مهمان Ubuntu 24.04 زنده است.** انتشار `nextops-0.1.0-e2dad3a` چهار مقصد ثابت Linux با فرمان اجباری را به تاریخچه و رویداد محدود Zabbix پیوند می‌دهد و توضیح رخداد را با مدل محلی CPU، شناسهٔ شاهد و ممیزی ثبت می‌کند. بررسی زندهٔ API، راه‌اندازی مجدد سرویس، بازگشت انتشار و مسیر سرور/API با WAN مسدود موفق‌اند؛ مرورگر تازهٔ زنده، reboot ترتیبی مرحلهٔ دو و قطع و بازیابی وابستگی مرحلهٔ دو هنوز `not_run` هستند. این نتیجه پذیرش تولیدی نیست؛ پشتیبان مستقل از datastore، WAL/PITR، چرخهٔ عمر گواهی و تأیید بازیابی بحران همچنان بازند. [مانیفست انتشار](docs/status/current-release.yaml)، [مشخصات و کارنامهٔ مرحلهٔ دو](docs/fa/PHASE_2_COMPLETION_SPEC.md) و [گزارش مرحلهٔ یک](docs/fa/STAGE_1_COMPLETION_REPORT.md) مرجع‌اند.
