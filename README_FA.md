...
> **وضعیت فعلی: مسیر دوزبانهٔ مرحلهٔ ۱ روی چهار مهمان Ubuntu 24.04 زنده است.** پنل با TLS خصوصی، هویت و ممیزی PostgreSQL، مدل ثابت و فقط‌CPU، اتصال کم‌اختیار و Zabbix 7.0.30 آزمون مرورگر تازه با WAN مسدود، راه‌اندازی مجدد، بازگشت برنامه/محیط اجرا/مدل، بازیابی خطا، بار محدود پنج‌دقیقه‌ای و بازیابی منطقیِ جدا را گذرانده‌اند. این نتیجه پذیرش تولیدی نیست؛ پشتیبان مستقل از datastore، WAL/PITR، چرخهٔ عمر گواهی و تأیید بازیابی بحران همچنان بازند. [مانیفست انتشار](docs/status/current-release.yaml) و [گزارش مرحلهٔ ۱](docs/fa/STAGE_1_COMPLETION_REPORT.md) مرجع‌اند.
