...
> **وضعیت فعلی: مسیر دوزبانهٔ ارزیابی کنترل‌شدهٔ کاربران روی چهار مهمان Ubuntu 24.04 زنده است.** پنل احرازهویت‌شده با TLS خصوصی، هویت و بررسی ماندگار مبتنی بر PostgreSQL همراه ممیزی، مدل محلی و ثابت روی CPU، اتصال فقط‌خواندنی با کمترین سطح دسترسی و مسیر Zabbix 7.0.30 در آزمون‌های محدود فارسی و انگلیسی، حالت‌های خرابی، قطع WAN هر چهار مهمان و راه‌اندازی مجدد سالم و ترتیبی موفق بوده‌اند. این نتیجه پذیرش تولیدی نیست؛ مرورگر تازه و مستقل با WAN قطع، بار پایدار، پشتیبان مستقل، بازیابی جداگانه و سناریوی بحران همچنان بازند. [مانیفست وضعیت انتشار](docs/status/current-release.yaml) خلاصهٔ ماشین‌خوان و پالایش‌شدهٔ قابلیت‌ها و دروازه‌هاست.
