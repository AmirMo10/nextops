...
توضیح مالک (۴ مهر ۱۴۰۵): مالک بازیابی از snapshot ماشین ESXi را آزموده است. گزارش تاریخ‌دار آن
در این بازبینی بررسی نشده و معیارهای پشتیبان و بازیابی مستقل پایگاه‌ها همچنان پذیرفته نیستند.

> **وضعیت فعلی: مسیر دوزبانه روی چهار مهمان Ubuntu 24.04 برای آزمون کنترل‌شدهٔ کاربران زنده است؛ پذیرش تولید انجام نشده است.** انتشار برنامه `nextops-0.1.0-01755d1` با پاسخ متمرکز به پرسش‌های فایل و فایل‌سیستم و پنل ساده‌تر فعال است؛ API هوش مصنوعی و اتصال‌دهنده روی `nextops-0.1.0-cdde129` مانده‌اند. آزمون تازهٔ API و مرورگر برای چند نمونهٔ محدود فارسی و انگلیسی، پیوند شواهد و ممیزی، چیدمان راست‌به‌چپ موبایل و منع WAN مرورگر موفق بود؛ این آزمون درستیِ عمومیِ پاسخ‌ها را اثبات نمی‌کند. شاهد پیشینِ راه‌اندازی مجدد، بازگشت، reboot ترتیبی و بازیابی وابستگی تاریخی است؛ تمرین بازگشتِ همین انتشار و مجموعهٔ کامل معناییِ پرسش‌های کنارگذاشته‌شده هنوز اجرا نشده‌اند. اکنون IPv4 عمومی در سطح میزبان قابل دسترسی است، اما واحدهای برنامه، AI و مدل به loopback و فرایند اتصال‌دهنده به شبکهٔ داخلی مجاز محدودند. مالک از snapshot روزانهٔ ESXi خبر داده و پشتیبان مستقل، PITR و restore ایزوله را از تحویل محلی کنونی به تعویق انداخته است؛ این موارد خطرِ تأییدنشده‌اند، نه معیارهای پذیرفته‌شده. چرخش گواهی و تحویل اعلان، مجوز پروژه، تأیید تمامیت انتشار و امضای نهایی مسئولان هنوز بازند. [مانیفست انتشار](docs/status/current-release.yaml)، [وضعیت جاری](docs/PROJECT_STATE.md) و [راهنمای موانع تولید](docs/fa/PRODUCTION_BLOCKERS_RUNBOOK.md) مرجع‌اند.
