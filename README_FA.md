...
> **وضعیت فعلی: مسیر دوزبانهٔ ارزیابی کنترل‌شدهٔ کاربران روی چهار مهمان Ubuntu 24.04 زنده است.** پنل احرازهویت‌شده با TLS خصوصی، PostgreSQL برنامه، مدل محلی و ثابت روی CPU، اتصال فقط‌خواندنی با کمترین سطح دسترسی و مسیر خودپایشی Zabbix 7.0.30 در آزمون سراسری فارسی و انگلیسی موفق بوده‌اند. این نتیجه پذیرش تولیدی نیست؛ پیوند ماندگار بررسی با ممیزی، پوشش میزبان‌های بیشتر، آزمون قطع WAN و راه‌اندازی مجدد، بار پایدار، پشتیبان، بازیابی و سناریوی بحران همچنان بازند.
