...
| 30 | UI / رابط کاربری | `packages/nextops/api/static`; future operations console | 2–8 | Bilingual three-mode panel and browser checks exist; source-only notice correction is unpromoted, and wider operations views remain / پنل سه‌حالتهٔ دوزبانه و آزمون مرورگر وجود دارد؛ اصلاح اعلان هنوز مستقر نشده و نماهای گستردهٔ عملیات باقی‌اند | I |
