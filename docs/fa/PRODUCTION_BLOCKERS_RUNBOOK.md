...
تحویلِ احتمالی آینده حفظ شده‌اند، نه به‌عنوان نخستین کار فعال. درستی برنامهٔ snapshot، موفقیت
بازیابی و استقلال پشتیبان تأیید نشده‌اند. پروفایل بازیابی مسدود می‌ماند و پذیرش کامل تولید هنوز
