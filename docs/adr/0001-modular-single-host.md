...
Status: proposed. Source: master sections 3, 5–7, 18, 20.
...
وضعیت: پیشنهادی. هستهٔ مدیریتی ماژولار، worker ماندگار جدا، درگاه MCP حفاظت‌شده، اتصال‌های لازم و مدل محلی انتخاب می‌شوند. جداسازی بر اساس اعتماد و منابع است، نه یک ریزسرویس برای هر ویژگی. وابستگی رو به دامنه و قرارداد دارای نوع حفظ شود.
