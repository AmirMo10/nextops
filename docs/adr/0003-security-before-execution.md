...
Status: proposed. Source: master sections 3, 11–14, 20–21.
...
وضعیت: پیشنهادی. هویت محدود، سیاست قطعی، جداسازی اطلاعات ورود، ممیزی ماندگار و قرارداد تأیید پیش از دسترسی واقعی زیرساخت ساخته می‌شوند. مدل پیشنهاد می‌دهد، اما حق اعطای مجوز، کاهش ریسک یا تغییر سیاست خودش ندارد. تغییرات در MVP غیرفعال می‌مانند.
