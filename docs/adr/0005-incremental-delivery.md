...
Status: proposed. Source: master sections 3–4, 8, 22–26.
...
وضعیت: پیشنهادی. ترتیب اولیهٔ امنیت و آفلاینِ دیرهنگام با مراحل صفر تا هشت و آزمون و مستندات و امنیت در همهٔ مراحل جایگزین می‌شود. یازده اتصال حفظ می‌شوند، اما شروع با بررسی کامل فارسی و فقط‌خواندنی Zabbix/Linux است. پیش از ساخت، معماری تأیید شود و آزمون آزمایشگاه از اجازهٔ بهره‌برداری جدا بماند.
