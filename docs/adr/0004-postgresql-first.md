...
Status: accepted on 2026-09-21. Source: master sections 3, 6, 11, 16.
...
وضعیت: پذیرفته‌شده در ۲۱ سپتامبر ۲۰۲۶. PostgreSQL مرجع اولیهٔ وضعیت، کار ماندگار، تأیید، ممیزی و فرادادهٔ توپولوژی و بازیابی است و با SQLAlchemy/Alembic و قید و migration آزموده به‌کار می‌رود. cache مرجع معتبر نیست. رابط پایگاه حفظ می‌شود، اما هم‌ارزی MySQL/SQLite پیش از آزمون انطباق ادعا نمی‌شود.
