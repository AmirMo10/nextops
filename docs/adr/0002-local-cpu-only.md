...
Status: proposed. Source: master sections 2–3, 9–10, 19.
...
وضعیت: پیشنهادی. همهٔ بارهای هوش مصنوعی روی CPU محلی اجرا می‌شوند. رابط ارائه‌دهنده حفظ می‌شود، اما تولید، بردارسازی، بازرتبه‌بندی و جایگزین ابری خارجی غیرفعال‌اند. آفلاین یعنی نبود وابستگی اینترنت پس از آماده‌سازی، نه قطع شبکهٔ مدیریت مجاز.
